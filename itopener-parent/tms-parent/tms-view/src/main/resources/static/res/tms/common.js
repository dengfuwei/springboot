...
//	$("footer").load("footer.html");
	...
	$("#admin-offcanvas").find('a[href="' + curr + '"]').parent().addClass("am-active");
...
//	if($.store("data-nav")){
//		$("[data-nav]").click();
////		nav.css("width", "50px").addClass("data-nav-close");
////		nav.find("span").not("[data-nav-icon]").hide();
//	}
});
...
$("[data-nav]").on("click", function(){
	...
	var nav = $("#" + navId);
	if(nav.hasClass("data-nav-close")){
		nav.css("width", "200px").removeClass("data-nav-close");
		nav.find("span").not("[data-nav-icon]").removeClass("am-hide");
		$.store("data-nav", "");
	} else{
		$.store("data-nav", "data-nav-close");
		nav.css("width", "50px").addClass("data-nav-close");
		nav.find("span").not("[data-nav-icon]").addClass("am-hide");
	}
});
    ...
    $.ajax = function(opt){  
        ...
        var _opt = $.extend(opt, {  
            ...
            success: function(data){  
            	...
            	if(typeof data =="object" && data.flag != 1){
            		layer.msg(data.msg, {
                	    offset: 0,
                	    shift: 6
                	});

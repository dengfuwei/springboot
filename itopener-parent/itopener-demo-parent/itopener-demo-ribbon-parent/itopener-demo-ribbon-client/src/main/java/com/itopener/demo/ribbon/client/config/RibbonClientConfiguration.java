package com.itopener.demo.ribbon.client.config;
...
public class RibbonClientConfiguration {
	 ...
	 */
	@Bean("restTemplateBalanced")
	@LoadBalanced
	public RestTemplate restTemplateBalanced(RestTemplateBuilder restTemplateBuilder) {

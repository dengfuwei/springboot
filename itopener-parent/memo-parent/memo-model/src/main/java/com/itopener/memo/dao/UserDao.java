...
import com.itopener.memo.conditions.UserCondition;

@Repository
public class UserDao {

	private final String NAMESPACE = "com.itopener.memo.mapper.UserMapper.";
	...
	public User selectByOpenId(long id) {
		return baseDao.selectOne(NAMESPACE + "selectByOpenId", id);
	}
